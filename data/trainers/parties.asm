...
ViolaGroup:
	; VIOLA (1)
	db "VIOLA@", TRAINERTYPE_MOVES
	; db  10, SURSKIT,    QUICK_ATTACK, BUBBLE, STRING_SHOT, NO_MOVE
	; db  12, VIVILLON,   HARDEN, LEECH_LIFE, TACKLE, SPIDER_WEB
	db  10, WEEDLE,     QUICK_ATTACK, BUBBLE, STRING_SHOT, NO_MOVE
	db  12, BEEDRILL,   HARDEN, LEECH_LIFE, TACKLE, SPIDER_WEB
	db -1 ; end
...
Rival1Group:
	...
	db 22, CHESPIN,    GROWL, REFLECT, RAZOR_LEAF, POISONPOWDER
	db -1 ; end
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, FENNEKIN,    LEER, SMOKESCREEN, EMBER, QUICK_ATTACK
	db -1 ; end
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, FROAKIE,   LEER, RAGE, WATER_GUN, BITE
	db -1 ; end
	...
	db 32, CHESPIN,   REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, FENNEKIN,    SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, FROAKIE, RAGE, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end
	...
	db 38, CHESPIN,   REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, FENNEKIN, SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, FROAKIE, RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
YoungsterGroup:
	...
	db 21, DIGGERSBY,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, DIGGERSBY,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, DIGGERSBY,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 26, CHESPIN,  LEECH_SEED, POISONPOWDER, SLEEP_POWDER, RAZOR_LEAF
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 32, CHESPIN,  GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 32, QUILLADIN,    GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 32, CHESNAUGHT,   BODY_SLAM, SLEEP_POWDER, RAZOR_LEAF, SWEET_SCENT
	db -1 ; end
...
BugCatcherGroup:
	...
	db 32, PINSIR,   DISABLE, SUPERSONIC, CONFUSION, LEECH_LIFE
	db -1 ; end
	...
	; BUG_CATCHER (17)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 32, PINSIR,   GUST, SUPERSONIC, PSYBEAM, LEECH_LIFE
	db -1 ; end

	; BUG_CATCHER (18)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 32, PINSIR,   GUST, SUPERSONIC, PSYCHIC_M, TOXIC
	db -1 ; end
...
Rival2Group:
	...
	db 45, CHESPIN,   RAZOR_LEAF, POISONPOWDER, BODY_SLAM, LIGHT_SCREEN
	db -1 ; end
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, FENNEKIN, SMOKESCREEN, QUICK_ATTACK, FLAME_WHEEL, SWIFT
	db -1 ; end
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, FROAKIE, RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
	...
	db 50, CHESPIN,   GIGA_DRAIN, BODY_SLAM, LIGHT_SCREEN, SAFEGUARD
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, FENNEKIN, SMOKESCREEN, QUICK_ATTACK, FIRE_BLAST, SWIFT
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, FROAKIE, SURF, RAIN_DANCE, SLASH, SCREECH
	db -1 ; end
...
PicnickerGroup:
	...
	db 38, CHESNAUGHT,   SOLARBEAM, RAZOR_LEAF, HEADBUTT, MUD_SLAP
	db -1 ; end
...
RedGroup:
	...
	db 77, CHESNAUGHT,   SUNNY_DAY, GIGA_DRAIN, SYNTHESIS, SOLARBEAM
...
ShaunaGroup:
	; SHAUNA (1) SHAUNA_1_CHESPIN
	db "SHAUNA@", TRAINERTYPE_ITEM
	db 5, CHESPIN,    BERRY
	db -1 ; end

	; SHAUNA (2) SHAUNA_1_FENNEKIN
	db "SHAUNA@", TRAINERTYPE_ITEM
	db 5, FENNEKIN,    BERRY
	db -1 ; end

	; SHAUNA (3) SHAUNA_1_FROAKIE
	db "SHAUNA@", TRAINERTYPE_ITEM
	db 5, FROAKIE,    BERRY
	db -1 ; end
	
	; ; SHAUNA (4) SHAUNA_2_CHESPIN
	; db "SHAUNA@", TRAINERTYPE_ITEM
	; db 16, EEVEE,    NO_ITEM
	; db 20, QUILLADIN,    BERRY
	; db -1 ; end

	; ; SHAUNA (5) SHAUNA_2_FENNEKIN
	; db "SHAUNA@", TRAINERTYPE_ITEM
	; db 16, EEVEE,    NO_ITEM
	; db 20, BRAIXEN,    BERRY
	; db -1 ; end

	; ; SHAUNA (6) SHAUNA_2_FROAKIE
	; db "SHAUNA@", TRAINERTYPE_ITEM
	; db 16, EEVEE,    NO_ITEM
	; db 20, FROGADIER,    BERRY
	; db -1 ; end
	
	; ; SHAUNA (7) SHAUNA_3_CHESPIN
	; db "SHAUNA@", TRAINERTYPE_ITEM
	; db 49, SYLVEON,    NO_ITEM
	; db 49, GOODRA,    NO_ITEM
	; db 51, CHESNAUGHT,    BERRY
	; db -1 ; end

	; ; SHAUNA (8) SHAUNA_3_FENNEKIN
	; db "SHAUNA@", TRAINERTYPE_ITEM
	; db 49, SYLVEON,    NO_ITEM
	; db 49, GOODRA,    NO_ITEM
	; db 51, DELPHOX,    BERRY
	...
	; ; SHAUNA (9) SHAUNA_3_FROAKIE
	; db "SHAUNA@", TRAINERTYPE_ITEM
	; db 49, SYLVEON,    NO_ITEM
	; db 49, GOODRA,    NO_ITEM
	; db 51, GRENINJA,    BERRY
	; db -1 ; end
	
CalemGroup:
	;fletchling gets replaced by swablu
	;only canon gender dif is meowstic's gender
	; CALEM (1) CALEM_1_CHESPIN
	db "?@", TRAINERTYPE_ITEM
	db  2, BUNNELBY,    NO_ITEM
	db  5, FLETCHLING,    NO_ITEM
	db  5, CHESPIN,    BERRY
	db -1 ; end

	; CALEM (2) CALEM_1_FENNEKIN
	db "?@", TRAINERTYPE_ITEM
	db  2, BUNNELBY,    NO_ITEM
	db  5, FLETCHLING,    NO_ITEM
	db  5, FENNEKIN,    BERRY
