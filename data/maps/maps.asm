...
MapGroup_Aquacorde:
	...
	map Route2SantaluneForestGate, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_29, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Santalune:
	map Route3, TILESET_KALOS, ROUTE, LANDMARK_ROUTE_3, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
