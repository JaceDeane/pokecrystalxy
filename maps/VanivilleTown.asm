...
VanivilleTown_MapEvents:
	...
	def_object_events
	object_event 12,  7, SPRITE_RIVAL, SPRITEMOVEDATA_STANDING_LEFT, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, -1, EVENT_RIVAL_NEW_BARK_TOWN ; RIVAL
	object_event 11,  7, SPRITE_SHAUNA, SPRITEMOVEDATA_STANDING_RIGHT, 1, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, -1, EVENT_RIVAL_NEW_BARK_TOWN ; SHAUNA
	;object_event 12, 7, SPRITE_SHAUNA, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, -1, -1 ; SHAUNA POST-GAME
